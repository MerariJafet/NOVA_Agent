...
def run_benchmark(url, prompt, iterations=10):
    ...
    print(f"Iteration | Status | Latency (ms)")
    print("-" * 35)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", default="http://localhost:8000/api/chat", help="Target endpoint")
    parser.add_argument("--prompt", default="Explain quantum physics in 2 sentences", help="Test prompt")
