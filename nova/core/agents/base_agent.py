...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        logger.info(
            "agent_initialized", agent_id=agent_id, name=name, specialty=specialty
        )
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        avg_response_time = (
            self.total_response_time / total_responses if total_responses > 0 else 0.0
        )
        ...
        return {
            ...
            "success_rate": (
                self.success_count / total_responses if total_responses > 0 else 0.0
            ),
